...
struct SelectableLinkTextView: UIViewRepresentable {
    ...
    final class Coordinator: NSObject, UITextViewDelegate {
        ...
        private func applyStreamingTailFade(in storage: NSTextStorage) {
            ...
            let tailCount = min(6, max(1, storage.length))
            ...
            case 2:
                alphas = [0.42, 0.10]
            case 3:
                alphas = [0.62, 0.30, 0.10]
            case 4:
                alphas = [0.78, 0.52, 0.28, 0.10]
            case 5:
                alphas = [0.86, 0.66, 0.44, 0.24, 0.10]
            default:
                alphas = [0.92, 0.76, 0.58, 0.38, 0.22, 0.10]
            }
